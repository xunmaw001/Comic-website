<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="漫画名称" prop="manhuamingcheng">
          <el-select :disabled="ro.manhuamingcheng" @change="manhuamingchengChange" v-model="ruleForm.manhuamingcheng" placeholder="请选择漫画名称">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.manhuamingcheng" label="漫画名称" prop="manhuamingcheng">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="漫画分类" prop="manhuafenlei">
          <el-input v-model="ruleForm.manhuafenlei" 
              placeholder="漫画分类" clearable  :readonly="ro.manhuafenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="漫画分类" prop="manhuafenlei">
              <el-input v-model="ruleForm.manhuafenlei" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="漫画标签" prop="manhuabiaoqian">
          <el-input v-model="ruleForm.manhuabiaoqian" 
              placeholder="漫画标签" clearable  :readonly="ro.manhuabiaoqian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="漫画标签" prop="manhuabiaoqian">
              <el-input v-model="ruleForm.manhuabiaoqian" 
                placeholder="漫画标签" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.manhuamingcheng = true;
          ...
          if(o=='manhuafenlei'){
            this.ruleForm.manhuafenlei = obj[o];
	    this.ro.manhuafenlei = true;
            continue;
          }
          if(o=='manhuabiaoqian'){
            this.ruleForm.manhuabiaoqian = obj[o];
	    this.ro.manhuabiaoqian = true;
            continue;
          }
          if(o=='fenlei'){
    ...
    // 下二随
    manhuamingchengChange () {
      this.$http({
        url: `follow/manhuatougao/manhuamingcheng?columnValue=`+ this.ruleForm.manhuamingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.manhuafenlei){
                this.ruleForm.manhuafenlei = data.data.manhuafenlei
              }
              if(data.data.manhuabiaoqian){
                this.ruleForm.manhuabiaoqian = data.data.manhuabiaoqian
              }
        } else {
          this.$message.error(data.msg);
        }
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springbootmw0s4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
